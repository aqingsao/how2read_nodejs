...
insert into readings(symbol, audio, is_correct, term) values("'guˌi:", 'ubuntu_guyi.mp3', 'true', (select id from terms where name='GUI'));
insert into readings(symbol, audio, is_correct, term) values("G-U-I", 'ubuntu_zhiyouai.mp3', 'false', (select id from terms where name='GUI'));
...
insert into readings(symbol, audio, is_correct, term) values("'weisˌdəu:", 'ubuntu_weisidou.mp3', 'true', (select id from terms where name='GUI'));
insert into readings(symbol, audio, is_correct, term) values("W-S-D-L", 'ubuntu_wsdl.mp3', 'false', (select id from terms where name='GUI'));

insert into Terms(name, source, description) values('Adobe', "", "图形用户界面，是指采用图形方式显示的计算机操作用户界面。");
insert into readings(symbol, audio, is_correct, term) values("ə'dəubi", 'ubuntu_edoubi.mp3', 'true', (select id from terms where name='Adobe'));
insert into readings(symbol, audio, is_correct, term) values("ə'dəub", 'ubuntu_edoubo.mp3', 'false', (select id from terms where name='Adobe'));
...
insert into readings(symbol, audio, is_correct, term) values("'eidʒæks", 'ubuntu_eizhaikes.mp3', 'true', (select id from terms where name='AJAX'));
insert into readings(symbol, audio, is_correct, term) values("ə'dʒæks", 'ubuntu_ezhaikes.mp3', 'false', (select id from terms where name='AJAX'));
insert into readings(symbol, audio, is_correct, term) values("a'dʒæks", 'ubuntu_azhaikes.mp3', 'false', (select id from terms where name='AJAX'));
insert into readings(symbol, audio, is_correct, term) values("a'dʒaks", 'ubuntu_ajiakes.mp3', 'false', (select id from terms where name='AJAX'));
